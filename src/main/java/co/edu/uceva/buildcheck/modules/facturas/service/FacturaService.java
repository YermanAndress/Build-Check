...
public class FacturaService {
    ...
    public Factura save(FacturaRequest request) {
        ...
        Proveedor proveedor = proveedorRepository
            .findByNombre(request.getProveedor())
            .orElseGet(() -> {
        ...
        Optional<Factura> facturaExistente =
            facturaRepository.findByNumeroFactura(request.getNumeroFactura());
        ...
        if (request.getProyectoId() == null) {
            throw new OperacionNoPermitidaException(
                "La factura debe tener un proyecto asociado"
            );
        }
        ...
        for (FacturaItemRequest itemRequest : request.getItems()) {
            ...
            material.setStockActual(
                material.getStockActual() + itemRequest.getCantidad()
            );
