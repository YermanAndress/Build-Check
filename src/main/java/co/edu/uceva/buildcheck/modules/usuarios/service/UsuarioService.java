...
public class UsuarioService {
    ...
    /**
     * Find first project associated with a user.
     * Used during login to determine if user needs to select a project.
     *
     * @param usuarioId User ID
     * @return Optional containing first UsuarioProyecto if user has any projects
     */
    @Transactional(readOnly = true)
